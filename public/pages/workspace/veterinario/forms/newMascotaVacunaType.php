...
$idUsuario = $_SESSION['idUsuario']; // ✅ corregido: este campo debe coincidir con mascota.Usuario_idUsuario
  ...
  <section id="ContenedorGeneral">
    ...
    <div class="container my-5">
      ...
      <?php if ($mascotas->num_rows === 0): ?>
        <div class="alert alert-warning">No se encontraron mascotas registradas para este usuario.</div>
      <?php else: ?>
        <form action="<?php echo PUBLIC_PAGES_URL; ?>workspace/veterinario/forms/action_guardarVacunacion.php" method="POST" class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <select name="Mascota_idMascota" id="mascota" class="form-select select2" required>
              ...
              <?php while ($m = $mascotas->fetch_assoc()): ?>
                <option value="<?php echo $m['idMascota']; ?>">
          ...
          <div class="col-md-6">
            ...
            <select name="Vacunas_idVacunas" id="vacuna" class="form-select select2" required>
              ...
              <?php while ($v = $vacunas->fetch_assoc()): ?>
                <option value="<?php echo $v['idVacunas']; ?>">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="veterinario" id="veterinario" class="form-control" maxlength="100" required>
          </div>

          <!-- Número de serie -->
          <div class="col-md-6">
            <label for="numero_serie" class="form-label">Número de serie</label>
            <input type="text" name="numero_serie" id="numero_serie" class="form-control" maxlength="60">
          </div>

          <!-- Fechas -->
          <div class="col-md-4">
            <label for="fecha_elaboracion" class="form-label">Fecha de colocación</label>
